...
__global__ void findMaxSingleThread(float *d_vec1, float *d_vec2, float *d_max1, float *d_max2, int n)
{
...
int main()
{
    ...
    findMaxSingleThread<<<numBlocks, numThreads>>>(d_vec1, d_vec2, d_max1, d_max2, N);
